...
Redux::set_section($opt_name, array(
		...
		'subsection'      => true,
		'customizer_width' => '400px',
		'desc'            => '<p class="description">' . esc_html__( 'Add links profiles for Social', 'wayup' ) . '</p>',
		'fields'          => array(
			array(
				'id'       => 'social_links',
				'type'     => 'sortable',
				'title'    => esc_html__( 'Social links', 'wayup' ),
				'subtitle' => esc_html__( 'Insert links for you social profiles', 'wayup' ),
...
Redux::set_section($opt_name, array(
		...
		'subsection'      => true,
		'customizer_width' => '400px',
		'desc'            => '<p class="description">' . esc_html__( 'Add Contacts data', 'wayup' ) . '</p>',
		'fields'          => array(
	        ...
	        array(
	         ...
	         array(
				...
				'msg'      => 'Email format is no correct',
				'default'  => '',
			),
	        array(
				'id'       => 'footer_copyright',
...
Redux::set_section($opt_name, array(
		...
		'fields'          => array(
			...
			array(
				'id'       => 'header_video',
				'type'     => 'text',
				'title'    => esc_html__( 'Specify the link', 'wayup' ),
				'default'  => '',
				'hint'     => array(
					 'title' => 'Ссылка с ютуба ',
                     'content' => 'Используйте простую ссылку на ролик с ютуба'
				),
			...
			array(
				...
				'type'     => 'text',
				'title'    => esc_html__( 'Specify the title', 'wayup' ),
				'default'  => '',
			),
			array(
				'id'            => 'home_header_slider',
				'type'          => 'slides',
				'title'         => esc_html__( 'Slider Example 1', 'wayup' ),
				'subtitle'      => esc_html__( 'This slider displays the value as a label.', 'wayup' ),
				'desc'          => esc_html__( 'Slider description. M', 'wayup' ),
				'placeholder'   => array(
                    'title'  => esc_html__('title', 'wayup'),
                    'description'  => esc_html__('description', 'wayup'),
                    'url'  => esc_html__('url', 'wayup'),
				),
			),
		),
	)
...
Redux::set_section($opt_name,array(
		...
		'id'               => 'posttypes',
		'desc'             => esc_html__( 'Options for Custom Post Type', 'wayup' ),
		'customizer_width' => '400px',
		'icon'             => 'el el-home',
	));
Redux::set_section($opt_name, array(
		...
		'subsection'      => true,
		'customizer_width' => '400px',
		'desc'            =>  esc_html__( 'Data for testimonial page', 'wayup' ),
		'fields'          => array(
			
			array(
				'id'       => 'title',
				'type'     => 'text',
				'title'    => esc_html__( 'Label', 'wayup' ),
			...
			array(
				'id'       => 'title2',
				'type'     => 'text',
				'title'    => esc_html__( 'Label 2', 'wayup' ),
			...
			array(
				...
				'desc'     => 'Установите плагин и введите шорткод формы',
				'default'  => ''
			),
...
Redux::set_section($opt_name, array(
		...
		'subsection'      => true,
		'customizer_width' => '400px',
		'desc'            =>  esc_html__( 'Data for Services page', 'wayup' ),
		'fields'          => array(
			array(
				'id'       => 'servicecurrency',
				'type'     => 'text',
			...
			array(
				'id'       => 'caseslabel',
				'type'     => 'text',
				'title'    => esc_html__( 'Заголовок для слайдера Кейсов', 'wayup' ),
				'default'  => 'Посмотрите наши последние кейсы',
			),
			array(
				'id'       => 'servicearchivetitle11',
				'type'     => 'text',
				'title'    => esc_html__( 'Первая часть заголовка', 'wayup' ),
				'default'  => 'Наши',
			),
			array(
				'id'       => 'servicearchivetitle12',
				'type'     => 'text',
				'title'    => esc_html__( 'Вторая часть заголовка', 'wayup' ),
				'default'  => 'Услуги',
			),
			array(
